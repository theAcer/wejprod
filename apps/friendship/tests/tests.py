...
class FriendshipViewTests(BaseTestCase):
    ...
    def test_friendship_view_users(self):
        url = reverse("friends:friendship_view_users")
    ...
    def test_friendship_view_friends(self):
        url = reverse(
            "friends:friendship_view_friends", kwargs={"username": self.user_bob.username}
        )
    ...
    def test_friendship_add_friend(self):
        url = reverse(
            "friends:friendship_add_friend", kwargs={"to_username": self.user_amy.username}
        )
        ...
        with self.login(self.user_bob.username, self.user_pw):
            ...
            self.assertResponse302(response)
            redirect_url = reverse("friends:friendship_request_list")
    ...
    def test_friendship_add_friend_dupe(self):
        ...
        url = reverse(
            "friends:friendship_add_friend", kwargs={"to_username": self.user_bob.username}
        )
    ...
    def test_friendship_requests(self):
        url = reverse("friends:friendship_request_list")
    ...
    def test_friendship_requests_rejected(self):
        url = reverse("friends:friendship_requests_rejected")
    ...
    def test_friendship_accept(self):
        ...
        with self.login(self.user_bob.username, self.user_pw):
            ...
            redirect_url = reverse(
                "friends:friendship_requests_detail",
                kwargs={"friendship_request_id": self.friendship_request.pk},
            )
            self.assertTrue(redirect_url in response["Location"])
    ...
    def test_friendship_followers(self):
        url = reverse("friends:friendship_followers", kwargs={"username": "bob"})
    ...
    def test_friendship_following(self):
        url = reverse("friends:friendship_following", kwargs={"username": "bob"})
    ...
    def test_follower_add(self):
        url = reverse(
            "friends:follower_add", kwargs={"followee_username": self.user_amy.username}
        )
        ...
        with self.login(self.user_bob.username, self.user_pw):
            ...
            self.assertResponse302(response)
            redirect_url = reverse(
                "friends:friendship_following", kwargs={"username": self.user_bob.username}
            )
            self.assertTrue(redirect_url in response["Location"])
    ...
    def test_follower_remove(self):
        ...
        url = reverse(
            "friends:follower_remove", kwargs={"followee_username": self.user_amy.username}
        )
    ...
    def test_friendship_blockers(self):
        url = reverse("friends:friendship_blockers", kwargs={"username": "bob"})
    ...
    def test_friendship_blocking(self):
        url = reverse("friends:friendship_blocking", kwargs={"username": "bob"})
    ...
    def test_block_add(self):
        url = reverse("friends:block_add", kwargs={"blocked_username": self.user_amy.username})
        ...
        with self.login(self.user_bob.username, self.user_pw):
            ...
            self.assertResponse302(response)
            redirect_url = reverse(
                "friends:friendship_blocking", kwargs={"username": self.user_bob.username}
            )
            self.assertTrue(redirect_url in response["Location"])
    ...
    def test_block_remove(self):
        ...
        url = reverse(
            "friends:block_remove", kwargs={"blocked_username": self.user_amy.username}
        )
